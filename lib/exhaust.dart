...
class ExhaustPage extends StatefulWidget {
  ...
  @override
  State<ExhaustPage> createState() => _ExhaustPageState();
}

class _ExhaustPageState extends State<ExhaustPage> {
  ...
  void showProduk() async {
    data = await SQFHelper.getBarangBy('exhaust');
  ...
  void search() async {
    data = await SQFHelper.searchBarang(txtSearch.text, 'exhaust');
    print(data);
    setState(() {
      isSearch = true;
    });
